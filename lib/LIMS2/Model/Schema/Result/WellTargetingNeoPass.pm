...
{
    $LIMS2::Model::Schema::Result::WellTargetingNeoPass::VERSION = '0.375';
}
## use critic
...
=head1 TABLE: C<well_targeting_neo_pass>

=cut

__PACKAGE__->table("well_targeting_neo_pass");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:cbrDHa5mVwofhMDs07irEg
