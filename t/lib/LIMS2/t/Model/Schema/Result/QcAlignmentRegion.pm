package LIMS2::t::Model::Schema::Result::QcAlignmentRegion;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::QcAlignmentRegion;
...
LIMS2/t/Model/Schema/Result/QcAlignmentRegion.pm - test class for LIMS2::Model::Schema::Result::QcAlignmentRegion
...
sub all_tests : Tests {
    ...
    my $rs            = 'QcAlignmentRegion';
    my %record        = ();

    local $TODO = 'Test of LIMS2::Model::Schema::Result::QcAlignmentRegion not implemented yet';
    ok( 1, "Test of LIMS2::Model::Schema::Result::QcAlignmentRegion" );
