package LIMS2::t::Model::Schema::Result::CrisprLocus;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::CrisprLocus;
...
LIMS2/t/Model/Schema/Result/CrisprLocus.pm - test class for LIMS2::Model::Schema::Result::CrisprLocus
...
sub all_tests  : Tests
{
    ...
    lives_ok { $crisprs_resultset->search(\%crisprs_record)->delete() } 'Deleting the existing test records';
    ...
    lives_ok { $crisprs_resultset->search(\%crisprs_record)->delete() } 'Deleting any existing test records';
