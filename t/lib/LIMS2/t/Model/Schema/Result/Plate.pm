package LIMS2::t::Model::Schema::Result::Plate;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::Plate;
...
LIMS2/t/Model/Schema/Result/Plate.pm - test class for LIMS2::Model::Schema::Result::Plate
