package LIMS2::Report::PlateByPlateReport;
...
override iterator => sub {
    ...
    my $data = $self->build_plate_based_data ();
...
my @data;
    foreach my $plate_rs (@rs) {
        ...
        my $row_data = $self->get_row_plate_based( \@design_list ,$plate->name );
