package LIMS2::t::Model::Schema::Result::Species;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::Species;
...
LIMS2/t/Model/Schema/Result/Species.pm - test class for LIMS2::Model::Schema::Result::Species
...
sub all_tests : Tests {
    ...
    local $TODO = 'Test of LIMS2::Model::Schema::Result::Species not implemented yet';
    ok( 1, "Test of LIMS2::Model::Schema::Result::Species" );
