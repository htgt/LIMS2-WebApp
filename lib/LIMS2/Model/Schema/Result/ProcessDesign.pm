use utf8;
package LIMS2::Model::Schema::Result::ProcessDesign;
## no critic(RequireUseStrict,RequireUseWarnings)
{
    $LIMS2::Model::Schema::Result::ProcessDesign::VERSION = '0.441';
}
## use critic
...
=head1 TABLE: C<process_design>

=cut

__PACKAGE__->table("process_design");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:7N9QN4E2chbsgcVuFDUw0w
