package LIMS2::t::Model::Schema::Result::QcSeqRead;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::QcSeqRead;
...
LIMS2/t/Model/Schema/Result/QcSeqRead.pm - test class for LIMS2::Model::Schema::Result::QcSeqRead
...
sub all_tests : Tests {
    ...
    local $TODO = 'Test of LIMS2::Model::Schema::Result::QcSeqRead not implemented yet';
    ok( 1, "Test of LIMS2::Model::Schema::Result::QcSeqRead" );
