use utf8;
package LIMS2::Model::Schema::Result::ProcessCrispr;
## no critic(RequireUseStrict,RequireUseWarnings)
{
    $LIMS2::Model::Schema::Result::ProcessCrispr::VERSION = '0.432';
}
## use critic
...
=head1 TABLE: C<process_crispr>

=cut

__PACKAGE__->table("process_crispr");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ryKgEzs0s3IPuQzRh3unrw
