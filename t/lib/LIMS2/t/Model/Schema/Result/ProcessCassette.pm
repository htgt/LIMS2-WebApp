package LIMS2::t::Model::Schema::Result::ProcessCassette;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::ProcessCassette;
...
LIMS2/t/Model/Schema/Result/ProcessCassette.pm - test class for LIMS2::Model::Schema::Result::ProcessCassette
...
sub all_tests : Tests {
    ...
    my $rs            = 'ProcessCassette';
    my %record        = ();

    local $TODO = 'Test of LIMS2::Model::Schema::Result::ProcessCassette not implemented yet';
    ok( 1, "Test of LIMS2::Model::Schema::Result::ProcessCassette" );
