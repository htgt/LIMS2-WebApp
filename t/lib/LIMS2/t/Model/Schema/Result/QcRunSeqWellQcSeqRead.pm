package LIMS2::t::Model::Schema::Result::QcRunSeqWellQcSeqRead;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::QcRunSeqWellQcSeqRead;
...
LIMS2/t/Model/Schema/Result/QcRunSeqWellQcSeqRead.pm - test class for LIMS2::Model::Schema::Result::QcRunSeqWellQcSeqRead
...
sub all_tests : Tests {
    ...
    my $rs            = 'QcRunSeqWellQcSeqRead';
    my %record        = ();

    local $TODO = 'Test of LIMS2::Model::Schema::Result::QcRunSeqWellQcSeqRead not implemented yet';
    ok( 1, "Test of LIMS2::Model::Schema::Result::QcRunSeqWellQcSeqRead" );
