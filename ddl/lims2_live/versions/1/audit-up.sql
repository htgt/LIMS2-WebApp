...
GRANT SELECT ON audit.roles TO lims2_live_ro;
GRANT SELECT,INSERT ON audit.roles TO lims2_live_rw;
...
GRANT SELECT ON audit.qc_seq_project_wells TO lims2_live_ro;
GRANT SELECT,INSERT ON audit.qc_seq_project_wells TO lims2_live_rw;
...
GRANT SELECT ON audit.schema_versions TO lims2_live_ro;
GRANT SELECT,INSERT ON audit.schema_versions TO lims2_live_rw;
...
GRANT SELECT ON audit.qc_alignments TO lims2_live_ro;
GRANT SELECT,INSERT ON audit.qc_alignments TO lims2_live_rw;
...
GRANT SELECT ON audit.user_role TO lims2_live_ro;
GRANT SELECT,INSERT ON audit.user_role TO lims2_live_rw;
...
GRANT SELECT ON audit.qc_templates TO lims2_live_ro;
GRANT SELECT,INSERT ON audit.qc_templates TO lims2_live_rw;
...
GRANT SELECT ON audit.qc_eng_seqs TO lims2_live_ro;
GRANT SELECT,INSERT ON audit.qc_eng_seqs TO lims2_live_rw;
...
GRANT SELECT ON audit.qc_alignment_regions TO lims2_live_ro;
GRANT SELECT,INSERT ON audit.qc_alignment_regions TO lims2_live_rw;
...
GRANT SELECT ON audit.users TO lims2_live_ro;
GRANT SELECT,INSERT ON audit.users TO lims2_live_rw;
...
GRANT SELECT ON audit.qc_test_results TO lims2_live_ro;
GRANT SELECT,INSERT ON audit.qc_test_results TO lims2_live_rw;
...
GRANT SELECT ON audit.qc_seq_reads TO lims2_live_ro;
GRANT SELECT,INSERT ON audit.qc_seq_reads TO lims2_live_rw;
...
GRANT SELECT ON audit.qc_runs TO lims2_live_ro;
GRANT SELECT,INSERT ON audit.qc_runs TO lims2_live_rw;
...
GRANT SELECT ON audit.qc_template_wells TO lims2_live_ro;
GRANT SELECT,INSERT ON audit.qc_template_wells TO lims2_live_rw;
...
GRANT SELECT ON audit.qc_run_seq_project TO lims2_live_ro;
GRANT SELECT,INSERT ON audit.qc_run_seq_project TO lims2_live_rw;
...
GRANT SELECT ON audit.qc_seq_projects TO lims2_live_ro;
GRANT SELECT,INSERT ON audit.qc_seq_projects TO lims2_live_rw;
