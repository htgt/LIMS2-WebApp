package LIMS2::t::Model::Schema::Result::QcTemplateWellCassette;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::QcTemplateWellCassette;
...
LIMS2/t/Model/Schema/Result/QcTemplateWellCassette.pm - test class for LIMS2::Model::Schema::Result::QcTemplateWellCassette
...
sub all_tests  : Tests
{
    ...
    my $rs = 'QcTemplateWellCassette';
    my %record = (
    );

    local $TODO = 'Test of LIMS2::Model::Schema::Result::QcTemplateWellCassette not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::QcTemplateWellCassette");
