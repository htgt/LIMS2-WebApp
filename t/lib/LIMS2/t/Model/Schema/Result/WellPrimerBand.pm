package LIMS2::t::Model::Schema::Result::WellPrimerBand;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::WellPrimerBand;
...
LIMS2/t/Model/Schema/Result/WellPrimerBand.pm - test class for LIMS2::Model::Schema::Result::WellPrimerBand
...
sub all_tests : Tests {
    ...
    my $rs            = 'WellPrimerBand';
    my %record        = ();

    local $TODO = 'Test of LIMS2::Model::Schema::Result::WellPrimerBand not implemented yet';
    ok( 1, "Test of LIMS2::Model::Schema::Result::WellPrimerBand" );
