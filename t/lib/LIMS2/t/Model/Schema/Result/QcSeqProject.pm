package LIMS2::t::Model::Schema::Result::QcSeqProject;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::QcSeqProject;
...
LIMS2/t/Model/Schema/Result/QcSeqProject.pm - test class for LIMS2::Model::Schema::Result::QcSeqProject
...
sub all_tests  : Tests
{
    ...
    local $TODO = 'Test of LIMS2::Model::Schema::Result::QcSeqProject not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::QcSeqProject");
