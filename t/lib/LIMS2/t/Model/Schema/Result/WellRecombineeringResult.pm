package LIMS2::t::Model::Schema::Result::WellRecombineeringResult;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::WellRecombineeringResult;
...
LIMS2/t/Model/Schema/Result/WellRecombineeringResult.pm - test class for LIMS2::Model::Schema::Result::WellRecombineeringResult
...
sub all_tests  : Tests
{
    ...
    my $rs = 'WellRecombineeringResult';
    my %record = (
    );

    local $TODO = 'Test of LIMS2::Model::Schema::Result::WellRecombineeringResult not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::WellRecombineeringResult");
