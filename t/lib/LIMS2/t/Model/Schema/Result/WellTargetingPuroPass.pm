package LIMS2::t::Model::Schema::Result::WellTargetingPuroPass;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::WellTargetingPuroPass;
...
LIMS2/t/Model/Schema/Result/WellTargetingPuroPass.pm - test class for LIMS2::Model::Schema::Result::WellTargetingPuroPass
...
sub all_tests  : Tests
{
    ...
    my $rs = 'WellTargetingPuroPass';
    my %record = (
    );

    local $TODO = 'Test of LIMS2::Model::Schema::Result::WellTargetingPuroPass not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::WellTargetingPuroPass");
