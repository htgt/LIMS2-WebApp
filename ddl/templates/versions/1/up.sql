...
GRANT SELECT ON qc_alignments TO "[% ro_role %]";
GRANT SELECT, INSERT, UPDATE, DELETE ON qc_alignments TO "[% rw_role %]";
GRANT USAGE ON SEQUENCE qc_alignments_id_seq TO "[% rw_role %]";
...
GRANT SELECT ON qc_alignment_regions TO "[% ro_role %]";
GRANT SELECT, INSERT, UPDATE, DELETE ON qc_alignment_regions TO "[% rw_role %]";
