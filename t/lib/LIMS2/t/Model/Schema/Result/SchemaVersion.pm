package LIMS2::t::Model::Schema::Result::SchemaVersion;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::SchemaVersion;
...
LIMS2/t/Model/Schema/Result/SchemaVersion.pm - test class for LIMS2::Model::Schema::Result::SchemaVersion
...
sub all_tests : Tests {
    ...
    local $TODO = 'Test of LIMS2::Model::Schema::Result::SchemaVersion not implemented yet';
    ok( 1, "Test of LIMS2::Model::Schema::Result::SchemaVersion" );
