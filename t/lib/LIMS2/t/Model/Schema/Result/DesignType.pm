package LIMS2::t::Model::Schema::Result::DesignType;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::DesignType;
...
LIMS2/t/Model/Schema/Result/DesignType.pm - test class for LIMS2::Model::Schema::Result::DesignType
...
sub all_tests : Tests {
    ...
    local $TODO = 'Test of LIMS2::Model::Schema::Result::DesignType not implemented yet';
    ok( 1, "Test of LIMS2::Model::Schema::Result::DesignType" );
