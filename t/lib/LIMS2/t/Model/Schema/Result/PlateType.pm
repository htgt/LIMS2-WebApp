package LIMS2::t::Model::Schema::Result::PlateType;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::PlateType;
...
LIMS2/t/Model/Schema/Result/PlateType.pm - test class for LIMS2::Model::Schema::Result::PlateType
...
sub all_tests  : Tests
{
    ...
    local $TODO = 'Test of LIMS2::Model::Schema::Result::PlateType not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::PlateType");
