package LIMS2::t::Model::Schema::Result::CrisprDesign;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::CrisprDesign;
...
LIMS2/t/Model/Schema/Result/CrisprDesign.pm - test class for LIMS2::Model::Schema::Result::CrisprDesign
