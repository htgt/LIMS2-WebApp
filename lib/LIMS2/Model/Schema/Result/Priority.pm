use utf8;
package LIMS2::Model::Schema::Result::Priority;
## no critic(RequireUseStrict,RequireUseWarnings)
{
    $LIMS2::Model::Schema::Result::Priority::VERSION = '0.434';
}
## use critic
...
Related object: L<LIMS2::Model::Schema::Result::Message>
