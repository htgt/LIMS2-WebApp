package LIMS2::t::Model::Schema::Result::Project;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::Project;
...
LIMS2/t/Model/Schema/Result/Project.pm - test class for LIMS2::Model::Schema::Result::Project
...
sub all_tests : Tests {
    ...
    local $TODO = 'Test of LIMS2::Model::Schema::Result::Project not implemented yet';
    ok( 1, "Test of LIMS2::Model::Schema::Result::Project" );
