package LIMS2::t::Model::Schema::Result::QcTemplateWell;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::QcTemplateWell;
...
LIMS2/t/Model/Schema/Result/QcTemplateWell.pm - test class for LIMS2::Model::Schema::Result::QcTemplateWell
