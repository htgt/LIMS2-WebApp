package LIMS2::t::Model::Schema::Result::QcRunSeqProject;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::QcRunSeqProject;
...
LIMS2/t/Model/Schema/Result/QcRunSeqProject.pm - test class for LIMS2::Model::Schema::Result::QcRunSeqProject
...
sub all_tests  : Tests
{
    ...
    my $rs = 'QcRunSeqProject';
    my %record = (
    );

    local $TODO = 'Test of LIMS2::Model::Schema::Result::QcRunSeqProject not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::QcRunSeqProject");
