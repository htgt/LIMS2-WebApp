package LIMS2::t::Model::Schema::Result::WellChromosomeFail;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::WellChromosomeFail;
...
LIMS2/t/Model/Schema/Result/WellChromosomeFail.pm - test class for LIMS2::Model::Schema::Result::WellChromosomeFail
...
sub all_tests : Tests {
    ...
    my $rs            = 'WellChromosomeFail';
    my %record        = ();

    local $TODO = 'Test of LIMS2::Model::Schema::Result::WellChromosomeFail not implemented yet';
    ok( 1, "Test of LIMS2::Model::Schema::Result::WellChromosomeFail" );
