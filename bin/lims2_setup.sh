...
function lims2_devel {
    ...
    export PERL5LIB=$PERL5LIB:/opt/sci/global/software/ensembl/ensembl-core-95/modules
    export PERL5LIB=$PERL5LIB:/opt/sci/global/software/ensembl/ensembl-variation-95/modules
