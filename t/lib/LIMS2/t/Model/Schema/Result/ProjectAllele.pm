package LIMS2::t::Model::Schema::Result::ProjectAllele;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::ProjectAllele;
...
LIMS2/t/Model/Schema/Result/ProjectAllele.pm - test class for LIMS2::Model::Schema::Result::ProjectAllele
...
sub all_tests : Tests {
    ...
    local $TODO = 'Test of LIMS2::Model::Schema::Result::ProjectAllele not implemented yet';
    ok( 1, "Test of LIMS2::Model::Schema::Result::ProjectAllele" );
