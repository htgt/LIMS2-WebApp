...
sub generate_sub_report {
    ...
    my $st_rpt_flds = {
        'Targeted Genes'                    => {
            ...
            'display_columns'       => [ 'gene id', 'gene symbol', 'crispr pairs', 'crispr wells', 'crispr vector wells', 'crispr dna wells', 'accepted crispr dna wells', 'accepted crispr pairs', 'vector designs', 'vector wells', 'targeting vector wells', 'accepted vector wells', 'passing vector wells', 'electroporations', 'colonies picked', 'targeted clones' ],
        },
        'Vectors'                           => {
