package LIMS2::t::Model::Schema::Result::ProcessInputWell;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::ProcessInputWell;
...
LIMS2/t/Model/Schema/Result/ProcessInputWell.pm - test class for LIMS2::Model::Schema::Result::ProcessInputWell
...
sub all_tests  : Tests
{
    ...
    my $rs = 'ProcessInputWell';
    my %record = (
    );

    local $TODO = 'Test of LIMS2::Model::Schema::Result::ProcessInputWell not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::ProcessInputWell");
