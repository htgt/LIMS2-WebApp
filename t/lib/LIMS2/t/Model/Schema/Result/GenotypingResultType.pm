package LIMS2::t::Model::Schema::Result::GenotypingResultType;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::GenotypingResultType;
...
LIMS2/t/Model/Schema/Result/GenotypingResultType.pm - test class for LIMS2::Model::Schema::Result::GenotypingResultType
...
sub all_tests : Tests {
    ...
    my $rs            = 'GenotypingResultType';
    my %record        = ();

    local $TODO = 'Test of LIMS2::Model::Schema::Result::GenotypingResultType not implemented yet';
    ok( 1, "Test of LIMS2::Model::Schema::Result::GenotypingResultType" );
