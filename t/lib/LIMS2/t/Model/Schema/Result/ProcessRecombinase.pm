package LIMS2::t::Model::Schema::Result::ProcessRecombinase;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::ProcessRecombinase;
...
LIMS2/t/Model/Schema/Result/ProcessRecombinase.pm - test class for LIMS2::Model::Schema::Result::ProcessRecombinase
...
sub all_tests  : Tests
{
    ...
    my $rs = 'ProcessRecombinase';
    my %record = (
    );

    local $TODO = 'Test of LIMS2::Model::Schema::Result::ProcessRecombinase not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::ProcessRecombinase");
