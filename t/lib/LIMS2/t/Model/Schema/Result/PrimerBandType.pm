package LIMS2::t::Model::Schema::Result::PrimerBandType;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::PrimerBandType;
...
LIMS2/t/Model/Schema/Result/PrimerBandType.pm - test class for LIMS2::Model::Schema::Result::PrimerBandType
...
sub all_tests  : Tests
{
    ...
    my $rs = 'PrimerBandType';
    my %record = (
    );

    local $TODO = 'Test of LIMS2::Model::Schema::Result::PrimerBandType not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::PrimerBandType");
