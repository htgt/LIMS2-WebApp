...
sub all_tests  : Tests
{
    ...
    lives_ok { $bac_clone_resultset->search(\%bac_clone_record)->delete() } 'Deleting the existing test records';
    lives_ok { $bac_library_resultset->search(\%bac_library_record)->delete() } 'Deleting the existing test records';
    ...
    lives_ok { $bac_library_resultset->search(\%bac_library_record)->delete() } 'Deleting any existing test records';
    ...
    lives_ok { $bac_clone_resultset->search(\%bac_clone_record)->delete() } 'Deleting any existing test records';
