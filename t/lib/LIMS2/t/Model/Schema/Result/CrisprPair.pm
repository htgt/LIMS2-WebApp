package LIMS2::t::Model::Schema::Result::CrisprPair;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::CrisprPair;
...
LIMS2/t/Model/Schema/Result/CrisprPair.pm - test class for LIMS2::Model::Schema::Result::CrisprPair
...
sub all_tests  : Tests
{
    ...
    local $TODO = 'Test of LIMS2::Model::Schema::Result::CrisprPair not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::CrisprPair");
