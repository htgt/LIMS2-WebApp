package LIMS2::t::Model::Schema::Result::Sponsor;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::Sponsor;
...
LIMS2/t/Model/Schema/Result/Sponsor.pm - test class for LIMS2::Model::Schema::Result::Sponsor
...
sub all_tests : Tests {
    ...
    local $TODO = 'Test of LIMS2::Model::Schema::Result::Sponsor not implemented yet';
    ok( 1, "Test of LIMS2::Model::Schema::Result::Sponsor" );
