...
ALTER TABLE audit.miseq_experiment ADD COLUMN nheg_reads integer;
...
ALTER TABLE audit.miseq_well_experiment ADD COLUMN indel_size_distribution_graph bytea;
