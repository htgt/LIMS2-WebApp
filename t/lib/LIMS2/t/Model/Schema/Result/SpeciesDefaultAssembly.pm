package LIMS2::t::Model::Schema::Result::SpeciesDefaultAssembly;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::SpeciesDefaultAssembly;
...
LIMS2/t/Model/Schema/Result/SpeciesDefaultAssembly.pm - test class for LIMS2::Model::Schema::Result::SpeciesDefaultAssembly
...
sub all_tests  : Tests
{
    ...
    my $rs = 'SpeciesDefaultAssembly';
    my %record = (
    );

    local $TODO = 'Test of LIMS2::Model::Schema::Result::SpeciesDefaultAssembly not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::SpeciesDefaultAssembly");
