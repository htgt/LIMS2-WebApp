...
$DB::single=1;
    ...
    is $gibson_rs->first->design_id, $design_id, 'can retrieve resultset
 for design_id ' . $design_id;
    ...
    ok my $primer_driver = LIMS2::Model::Util::OligoSelection::pick_genotyping_primers( model->schema, $design_id ), 'Running primer3';
}
