package LIMS2::t::Model::Schema::Result::UserPreference;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::UserPreference;
...
LIMS2/t/Model/Schema/Result/UserPreference.pm - test class for LIMS2::Model::Schema::Result::UserPreference
...
sub all_tests : Tests {
    ...
    my $rs            = 'UserPreference';
    my %record        = ();

    local $TODO = 'Test of LIMS2::Model::Schema::Result::UserPreference not implemented yet';
    ok( 1, "Test of LIMS2::Model::Schema::Result::UserPreference" );
