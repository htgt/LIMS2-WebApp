package LIMS2::t::Model::Schema::Result::BacClone;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::BacClone;
...
LIMS2/t/Model/Schema/Result/BacClone.pm - test class for LIMS2::Model::Schema::Result::BacClone
