package LIMS2::t::Model::Schema::Result::ProcessOutputWell;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::ProcessOutputWell;
...
LIMS2/t/Model/Schema/Result/ProcessOutputWell.pm - test class for LIMS2::Model::Schema::Result::ProcessOutputWell
...
sub all_tests  : Tests
{
    ...
    my $rs = 'ProcessOutputWell';
    my %record = (
    );

    local $TODO = 'Test of LIMS2::Model::Schema::Result::ProcessOutputWell not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::ProcessOutputWell");
