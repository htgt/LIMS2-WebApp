package LIMS2::t::Model::Schema::Result::Recombinase;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::Recombinase;
...
LIMS2/t/Model/Schema/Result/Recombinase.pm - test class for LIMS2::Model::Schema::Result::Recombinase
...
sub all_tests  : Tests
{
    ...
    local $TODO = 'Test of LIMS2::Model::Schema::Result::Recombinase not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::Recombinase");
