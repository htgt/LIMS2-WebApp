use utf8;
package LIMS2::Model::Schema::Result::ProcessDoubling;
...
=head1 TABLE: C<process_doublings>

=cut

__PACKAGE__->table("process_doublings");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:uW9tPoLDWP8vR+xGAWfnVA
