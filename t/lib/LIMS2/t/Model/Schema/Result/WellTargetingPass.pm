package LIMS2::t::Model::Schema::Result::WellTargetingPass;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::WellTargetingPass;
...
LIMS2/t/Model/Schema/Result/WellTargetingPass.pm - test class for LIMS2::Model::Schema::Result::WellTargetingPass
...
sub all_tests : Tests {
    ...
    my $rs            = 'WellTargetingPass';
    my %record        = ();

    local $TODO = 'Test of LIMS2::Model::Schema::Result::WellTargetingPass not implemented yet';
    ok( 1, "Test of LIMS2::Model::Schema::Result::WellTargetingPass" );
