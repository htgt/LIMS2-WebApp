package LIMS2::t::Model::Schema::Result::RecombineeringResultType;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::RecombineeringResultType;
...
LIMS2/t/Model/Schema/Result/RecombineeringResultType.pm - test class for LIMS2::Model::Schema::Result::RecombineeringResultType
...
sub all_tests  : Tests
{
    ...
    my $rs = 'RecombineeringResultType';
    my %record = (
    );

    local $TODO = 'Test of LIMS2::Model::Schema::Result::RecombineeringResultType not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::RecombineeringResultType");
