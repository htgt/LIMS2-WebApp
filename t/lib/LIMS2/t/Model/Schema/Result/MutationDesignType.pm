package LIMS2::t::Model::Schema::Result::MutationDesignType;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::MutationDesignType;
...
LIMS2/t/Model/Schema/Result/MutationDesignType.pm - test class for LIMS2::Model::Schema::Result::MutationDesignType
...
sub all_tests  : Tests
{
    ...
    my $rs = 'MutationDesignType';
    my %record = (
    );

    local $TODO = 'Test of LIMS2::Model::Schema::Result::MutationDesignType not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::MutationDesignType");
