package LIMS2::t::Model::Schema::Result::GenotypingPrimer;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::GenotypingPrimer;
...
LIMS2/t/Model/Schema/Result/GenotypingPrimer.pm - test class for LIMS2::Model::Schema::Result::GenotypingPrimer
...
sub all_tests  : Tests
{
    ...
    my $rs = 'GenotypingPrimer';
    my %record = (
    );

    local $TODO = 'Test of LIMS2::Model::Schema::Result::GenotypingPrimer not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::GenotypingPrimer");
