package LIMS2::t::Model::Schema::Result::GenotypingPrimerType;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::GenotypingPrimerType;
...
LIMS2/t/Model/Schema/Result/GenotypingPrimerType.pm - test class for LIMS2::Model::Schema::Result::GenotypingPrimerType
...
sub all_tests  : Tests
{
    ...
    my $rs = 'GenotypingPrimerType';
    my %record = (
    );

    local $TODO = 'Test of LIMS2::Model::Schema::Result::GenotypingPrimerType not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::GenotypingPrimerType");
