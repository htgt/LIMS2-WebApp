use utf8;
package LIMS2::Model::Schema::Result::ProcessNuclease;
## no critic(RequireUseStrict,RequireUseWarnings)
{
    $LIMS2::Model::Schema::Result::ProcessNuclease::VERSION = '0.415';
}
## use critic
...
=head1 TABLE: C<process_nuclease>

=cut

__PACKAGE__->table("process_nuclease");
...
Related object: L<LIMS2::Model::Schema::Result::Nuclease>
