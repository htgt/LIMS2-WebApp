package LIMS2::t::Model::Schema::Result::WellGenotypingResult;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::WellGenotypingResult;
...
LIMS2/t/Model/Schema/Result/WellGenotypingResult.pm - test class for LIMS2::Model::Schema::Result::WellGenotypingResult
...
sub all_tests  : Tests
{
    ...
    my $rs = 'WellGenotypingResult';
    my %record = (
    );

    local $TODO = 'Test of LIMS2::Model::Schema::Result::WellGenotypingResult not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::WellGenotypingResult");
