...
{
    $LIMS2::Model::Schema::Result::CellLineRepository::VERSION = '0.532';
}
## use critic
...
=head1 TABLE: C<cell_line_repositories>

=cut

__PACKAGE__->table("cell_line_repositories");
...
__PACKAGE__->has_many(
  ...
  { "foreign.repository" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);


# Created by DBIx::Class::Schema::Loader v0.07022 @ 2019-02-15 08:32:40
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:S2qZ7pOGgTJkfoXdz4KugA
