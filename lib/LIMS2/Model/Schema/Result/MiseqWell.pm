use utf8;
package LIMS2::Model::Schema::Result::MiseqWell;
...
=head1 TABLE: C<miseq_well>

=cut

__PACKAGE__->table("miseq_well");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:VZl29HOYrKK/xiIZF7GmmA
