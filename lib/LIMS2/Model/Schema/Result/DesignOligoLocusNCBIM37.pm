...
{
    $LIMS2::Model::Schema::Result::DesignOligoLocusNCBIM37::VERSION = '0.008';
}
## use critic
...
join design_oligo_loci g5_locus on g5_locus.design_oligo_id = g5.id and g5_locus.assembly_id = 'NCBIM37'
join design_oligos u5 on u5.design_id = designs.id and u5.design_oligo_type_id = 'U5'
join design_oligo_loci u5_locus on u5_locus.design_oligo_id = u5.id and u5_locus.assembly_id = 'NCBIM37'
left outer join design_oligos u3 on u3.design_id = designs.id and u3.design_oligo_type_id = 'U3'
left outer join design_oligo_loci u3_locus on u3_locus.design_oligo_id = u3.id and u3_locus.assembly_id = 'NCBIM37'
left outer join design_oligos d5 on d5.design_id = designs.id and d5.design_oligo_type_id = 'D5'
left outer join design_oligo_loci d5_locus on d5_locus.design_oligo_id = d5.id and d5_locus.assembly_id = 'NCBIM37'
join design_oligos d3 on d3.design_id = designs.id and d3.design_oligo_type_id = 'D3'
join design_oligo_loci d3_locus on d3_locus.design_oligo_id = d3.id and d3_locus.assembly_id = 'NCBIM37'
join design_oligos g3 on g3.design_id = designs.id and g3.design_oligo_type_id = 'G3'
join design_oligo_loci g3_locus on g3_locus.design_oligo_id = g3.id and g3_locus.assembly_id = 'NCBIM37'
EOT
