use utf8;
package LIMS2::Model::Schema::Result::ProjectInformation;
...
=head1 TABLE: C<project_information>

=cut

__PACKAGE__->table("project_information");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:8CC3y6UBi4bu9f7s0JE45Q
