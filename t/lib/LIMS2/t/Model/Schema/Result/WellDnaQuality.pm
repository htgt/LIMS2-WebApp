package LIMS2::t::Model::Schema::Result::WellDnaQuality;
use base qw(Test::Class);
use Test::Most;
use LIMS2::Model::Schema::Result::WellDnaQuality;
...
LIMS2/t/Model/Schema/Result/WellDnaQuality.pm - test class for LIMS2::Model::Schema::Result::WellDnaQuality
...
sub all_tests  : Tests
{
    ...
    my $rs = 'WellDnaQuality';
    my %record = (
    );

    local $TODO = 'Test of LIMS2::Model::Schema::Result::WellDnaQuality not implemented yet';
    ok(1, "Test of LIMS2::Model::Schema::Result::WellDnaQuality");
