use utf8;
package LIMS2::Model::Schema::Result::ProcessCrisprGroup;
## no critic(RequireUseStrict,RequireUseWarnings)
{
    $LIMS2::Model::Schema::Result::ProcessCrisprGroup::VERSION = '0.523';
}
## use critic
...
=head1 TABLE: C<process_crispr_group>

=cut

__PACKAGE__->table("process_crispr_group");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ne0xKrDYUjk/EjM171rW2Q
