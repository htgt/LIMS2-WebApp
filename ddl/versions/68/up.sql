...
ALTER TABLE crispr_es_qc_wells ALTER COLUMN analysis_data TYPE json USING analysis_data::JSON;
ALTER TABLE design_attempts ALTER COLUMN design_ids TYPE integer[] using CASE WHEN design_ids IS NOT NULL THEN array[design_ids::int] ELSE NULL;
