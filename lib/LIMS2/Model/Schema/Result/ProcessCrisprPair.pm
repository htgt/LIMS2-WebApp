use utf8;
package LIMS2::Model::Schema::Result::ProcessCrisprPair;
## no critic(RequireUseStrict,RequireUseWarnings)
{
    $LIMS2::Model::Schema::Result::ProcessCrisprPair::VERSION = '0.528';
}
## use critic
...
=head1 TABLE: C<process_crispr_pair>

=cut

__PACKAGE__->table("process_crispr_pair");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QNcgNO+FRMNq1mk2SZe+Vw
