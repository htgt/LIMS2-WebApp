...
{
    $LIMS2::Model::Schema::Result::SequencingPrimerType::VERSION = '0.427';
}
## use critic
...
=head1 TABLE: C<sequencing_primer_types>

=cut

__PACKAGE__->table("sequencing_primer_types");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:iWVxh7/H0jeErWsLwA0Kcg
